...
namespace Student_Management_Platform.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,tel_no")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,tel_no")] registration registration)
        {
            if (ModelState.IsValid)
            {
